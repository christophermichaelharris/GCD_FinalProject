 ...
 *  Created by Christopher Harris (username: `christopherharris`).

 *  Report creation time: Sun Mar 03 2019 11:47:56

 *  Report was run from directory: `/Users/christopherharris/Desktop/R`
 ...
 *  Function call: `makeDataReport(data = new_data, mode = c("summarize", "visualize", 
"check"), smartNum = FALSE, file = "codebook_new_data.Rmd", checks = list(
